  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-base z-50 border border-foreground dark:text-white bg-transparent text-black h-full rounded-lg focus:outline-none focus:ring-0 pl-4 pr-20",
